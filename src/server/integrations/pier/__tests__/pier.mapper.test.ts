...
import { mapPost } from "../pier.mapper";
...
describe("mapPost", () => {
  it("reconhece os aliases reais da API V2", () => {
    const post = mapPost(
      {
        idPostagem: 998877,
        postagemTexto: "Segue demonstrativo atualizado de 01.2026 à 05.2026, para validação.",
  ...
  it("mantém compatibilidade com os nomes antigos", () => {
    const post = mapPost({ id: "1", mensagem: "ok", criadoEm: "2026-01-02" }, "10");
